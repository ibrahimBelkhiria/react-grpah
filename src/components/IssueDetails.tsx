...
function IssueDetails(props: any) {
    ...
    <div>
        <div className="card card-style">
            ...
            <div> <strong>Created By</strong> &nbsp; <a href={issue.author.url} target="_blank" rel='noopener noreferrer' >{issue.author.login}</a></div>
        ...
        {issue.comments.nodes.length!==0 ?
           <div className="box">
            { issue.comments.nodes.map((comment:any) => (
                ...
                <strong>Commented By <a href={comment.author.url} target="_blank" rel='noopener noreferrer' > {comment.author.login}</a></strong>
                </div>
